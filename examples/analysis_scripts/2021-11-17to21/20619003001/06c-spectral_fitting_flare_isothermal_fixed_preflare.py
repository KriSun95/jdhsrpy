...
spectral_fitting.set_double_thermal_model(fitter)
...
fitter.params["T1_spectrum1"] = {"Status":"fix", "Value":3.3}
fitter.params["EM1_spectrum1"] = {"Status":"fix", "Value":9.42e-1}
fitter.params["T2_spectrum1"] = {"Value":10, "Bounds":(5, 15)}
fitter.params["EM2_spectrum1"] = {"Value":5.5e-2, "Bounds":(5e-3, 9e-1)}
