...
fitter.params["T2_spectrum1"] = {"Value":6.5, "Bounds":(4, 8)}
fitter.params["EM2_spectrum1"] = {"Value":5.5e-2, "Bounds":(5e-3, 5e-1)}
fitter.params["T3_spectrum1"] = {"Status":"freeze", "Value":10, "Bounds":(5, 15)}
fitter.params["EM3_spectrum1"] = {"Status":"freeze", "Value":5.5e-4, "Bounds":(1e-4, 1e-2)}
...
fitter.energy_fitting_range = [5, 8]
...
fitter.params["T2_spectrum1"] = {"Status":"free"}
fitter.params["EM2_spectrum1"] = {"Status":"free"}
fitter.fit()
